...
I believe that a Masters with Security concentration at the University of South California is an ideal next step for me to get an academic understanding and gain research experience not only on the topics above but all aspects of computer security. Furthermore, this also provides an opportunity to interact and work with brilliant professors, specifically Dr. Clifford Neuman and Dr. Muhammad Naveed, whose research areas~\cite{ryutov2005adaptive, grubbs2017leakage, zhang2015leave} aligns perfectly with my current interests.
