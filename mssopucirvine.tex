...
I believe that a Masters with Security specialization at the University of California, Irvine is an ideal next step for me to get an academic understanding and gain research experience not only on the topics above but all aspects of computer security. Furthermore, this also provides an opportunity to interact and work with brilliant professors, specifically Dr. Michael Franz and Dr. Ardalan Amiri Sani, whose research areas~\cite{talebi2018charm, rudd2017address} aligns perfectly with my current interests.
