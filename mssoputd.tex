...
I believe that a Masters in Information Assurance at the University of Texas, Dallas is an ideal next step for me to get an academic understanding and gain research experience not only on the topics above but all aspects of computer security. Furthermore, this also provides an opportunity to interact and work with brilliant professors, specifically Dr. Zhiqiang Lin and Dr. Yvo Desmedt, whose research areas~\cite{ZhiqiangLin, ZhiqiangLin01} aligns perfectly with my current interests.
